...
- `tools/` - ferramentas/scripts que pode ser utilizados pelos agentes pra diversas finalizades, ex: `tools/n8n` (construção de workflows e gerenciamente de workflows do n8n) e `tools/video`(video production)
...
| **prompt-timer**        | `extensions/prompt-timer.ts`        | Response time tracker — shows elapsed time between user prompt and assistant response in a widget above the editor                                          |
...
just ext-prompt-timer       # Response time tracker widget
...
- **[BEST_PRACTICES.md](BEST_PRACTICES.md)** — Windows compatibility, UI composition patterns, common pitfalls to avoid when authoring extensions.
